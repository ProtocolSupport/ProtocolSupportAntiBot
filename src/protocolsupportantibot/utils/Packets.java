...
public class Packets {
	...
	public static Object createTransactionPacket() {
	...
	public static Object createEmptyChunkPacket() {
	...
	public static Object createTeleportPacket(double x, double y, double z, float yaw, float pitch) {
	...
	public static Object createSetSlotPacket(int slot, ItemStack itemstack) {
	...
	public static Object createMapDataPacket(int subId, byte[] mapdata) {
	...
	public static Object createChatPacket(String message) {
